      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="{{route('register')}}" class="btn-get-started scrollto">Check Your Personality</a>
  ...
  <main id="main">
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-5 align-items-stretch  img" style='background-image: url("assets/img/our_vision.jpg"); padding-bottom: 15px;' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  " style="padding-top:20px;">
            <div class="accordion-list">
              <h3 style="text-align:left; color: #37517e;">OUR <strong>VISION</strong></h3>
              <ul>
                <li>
                  <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"> VISION <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                ...
                <li style="padding-top: 20px;">
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"> MISSION <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class=" d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <h4><a>Professional Counselling From Top Industry Professionals Ranging From
                  Different
                  Universities</a></h4>
              <p style="text-align:justify;">
          ...
          <div class="d-flex align-items-stretch mt-4 " data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <h4><a>Strongly Curated Forums To Spread Highly Credible Information To Our
                  Audience.</a></h4>
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Tanya and kinza -> Lahore <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Hassan -> Islamabad <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Sabreen -> Taxla <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
    ...
    <section id="team" class="team section-bg">
      <div class="container" data-aos="fade-up">
        ...
        $counselors = User::with('profile')
        ->where('role','c')->whereRelation('profile','profession','!=','NA')->get();
        @endphp
        ...
        <div class="row">
          ...
          <div class="col-lg-6 my-4" >
            <div class="member d-flex align-items-start" style="max-height: 250px;" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic">
                @if ($counselor->profile->profile_image != "NA")
                <img src="{{ asset('images/'.$counselor->profile->profile_image)}}" class="img-fluid">
                @else
              ...
              <div class="member-info">
                ...
                <p>{{$counselor->profile->profession}}</p>
                <p>{{ Str::limit($counselor->profile->intro, 200) }}</p>
      ...
      <div>
        <div class="d-flex justify-content-center justify-content-lg-center">
          <a href="{{route('register')}}" class="btn-get-started scrollto" style="margin-top: 3rem; background-color: rgba(40, 58, 90, 0.9);">Find More Counsellers</a>
        </div>
      </div>
    </section>
    <!-- End Team Section -->
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              ...
              <iframe src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Islamabad Pakistan&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          <button type="button" class="btn btn-primary d-block my-3 w-100" data-toggle="modal" data-target="#registerModal1" data-dismiss="modal">Signup As Student</button>
          <button type="button" class="btn btn-primary d-block w-100 mb-3" data-toggle="modal" data-target="#registerModal2" data-dismiss="modal">Signup As Counseller</button>
        </div>
          ...
          <form onsubmit="login(event)">
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon" style="background-color: #37517e; border: #37517e;"><i class="fa fa-envelope"></i></span>
                <input type="email" class="form-control" name="email" placeholder="Enter email address" required="required">
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon" style="background-color: #37517e; border: #37517e;"><i class="fa fa-lock"></i></span>
            ...
            <div class="form-group text-center">
              <button type="submit" class="btn btn-primary btn-signin" style="background-color: #37517e; border: #37517e;">login</button>

            </div>

          </form>
        </div>
        <div class="text-center mb-3">Don't have an account? <a class="register" href="#signupOptions" data-dismiss="modal" data-toggle="modal" style="color: #37517e;">Register</a></div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content" style="background-color: #e5e5e5;">
        ...
        <div class="modal-body" style="background-color: transparent;">
          ...
          <form id="student" onsubmit="registerStudent(event)">
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon" style="background-color: #37517e; border: #37517e;"><i class="fa fa-user"></i></span>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon" style="background-color: #37517e; border: #37517e;"><i class="fa fa-eye-slash"></i></span>
            ...
            <div class="form-group text-center">
              <button type="submit" class="btn btn-primary btn-signin" style="background-color: #37517e; border: #37517e;">Register</button>

            </div>

          </form>
        </div>
        <div class="text-center mb-3">Already have an account? <a class="login" href="#loginModal1" data-dismiss="modal" data-toggle="modal" style="color: #37517e;">Login</a></div>
      </div>
    </div>
  </div>
