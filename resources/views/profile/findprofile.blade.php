        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 ">
            ...
            <form action="{{route('counselors.show')}}" method="POST" class="flex items-center mb-5">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="search" name="search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search Counselors..." required>
